...
<Steps>
  <Step title="Accountability Layer">
    The foundation of transparency, verifiable work and reasoning
  </Step>
  <Step title="Context Layer">
    A system to unlock knowledge, culture, and goals
  </Step>
  <Step title="Coordination Layer">
    Enabling agents to collaborate seamlessly with shared knowledge systems
  </Step>
  <Step title="Tooling layer">
    Equipping agents with the tools and software to maximize their autonomy
  </Step>
</Steps>
...
<CardGroup>
  <Card title="Accountability Layer ↔ Context Layer" icon="arrows-left-right" color="#22c55e">
    Ensures verifiable work with proper knowledge context
  </Card>
  <Card title="Context Layer ↔ Coordination Layer" icon="arrows-left-right" color="#3b82f6">
    Provides knowledge systems for seamless agent collaboration
  </Card>
  <Card title="Coordination Layer ↔ Tooling Layer" icon="arrows-left-right" color="#a855f7">
