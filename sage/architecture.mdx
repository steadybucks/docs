...
<CardGroup>
  <Card title="Execution Layer ↔ Context Layer" icon="arrows-left-right" color="#a855f7">
    Provides context for agents to work with
  </Card>
  <Card title="Verification Layer ↔ Context Layer" icon="arrows-left-right" color="#22c55e">
    Ensures verifiable work with proper knowledge context
  </Card>
  <Card title="Context Layer ↔ Orchestration Layer" icon="arrows-left-right" color="#3b82f6">
    Provides knowledge systems for seamless agent collaboration
  </Card>
  <Card title="Orchestration Layer ↔ Tooling Layer" icon="arrows-left-right" color="#a855f7">
